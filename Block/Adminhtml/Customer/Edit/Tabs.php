...
namespace Braspag\Webkul\Block\Adminhtml\Customer\Edit;
...
class Tabs extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        $this->options = $options ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Magento\Store\Ui\Component\Listing\Column\Store\Options::class);
    ...
    public function initForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('Braspag Subordinate Merchant Id'),
                'value' => $partner['braspag_subordinate_merchantid'],
            ]
        );
        ...
        $fieldset->addField(
            ...
            'text',
            [
                'name' => 'braspag_subordinate_mdr',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Braspag Subordinate Mdr'),
                'title' => __('Braspag Subordinate Mdr'),
                'value' => $partner['braspag_subordinate_mdr'],
            ]
        );
